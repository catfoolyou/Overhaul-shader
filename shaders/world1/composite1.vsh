...
vec3 skyColorArr[24] = vec3[24](
    vec3(0.02, 0.02, 0.027),        // 0-1000
    vec3(0.02, 0.02, 0.027),        // 1000 - 2000
    vec3(0.02, 0.02, 0.027),        // 2000 - 3000
    vec3(0.02, 0.02, 0.027),        // 3000 - 4000
    vec3(0.02, 0.02, 0.027),        // 4000 - 5000 
    vec3(0.02, 0.02, 0.027),        // 5000 - 6000
    vec3(0.02, 0.02, 0.027),        // 6000 - 7000
    vec3(0.02, 0.02, 0.027),        // 7000 - 8000
    vec3(0.02, 0.02, 0.027),        // 8000 - 9000
    vec3(0.02, 0.02, 0.027),        // 9000 - 10000
    vec3(0.02, 0.02, 0.027),        // 10000 - 11000
    vec3(0.02, 0.02, 0.027),        // 11000 - 12000
    vec3(0.02, 0.02, 0.027),        // 12000 - 13000
